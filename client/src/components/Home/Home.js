        ...
        <div className="row px-3">
          <div className="col-md-6 p-0">
            <div className="gym-class-box-left  d-flex flex-column align-items-end justify-content-center  text-right text-white py-5 px-5">
              ...
              <p>
                Muscle building has many benefits, including increased strength,
                improved joint function, and increased calorie burning. Muscle
                building can also help to improve balance and coordination. A
                well-rounded muscle-building program should include exercises
                for all major muscle groups, including the chest, back,
          ...
          <div className="col-md-6 p-0">
            <div className="gym-class-box-right d-flex flex-column align-items-start justify-content-center text-left text-white py-5 px-5">
              ...
              <p>
                Losing weight and keeping it off can seem like an impossible
                task, but with the right approach it is definitely achievable.
                The key to success is finding a weight loss plan that works for
                you and sticking to it. There is no one-size-fits-all solution,
                so it is important to find a plan that fits your lifestyle and
                food preferences.
              </p>
              <a href="" className="btn btn-lg btn-outline-light mt-4 px-4">
                Join Now
        ...
        <div className="row px-3 align-items-center">
          <div className="col-md-6">
            <div className="pr-md-3 d-none d-md-block">
              ...
              <h4 className="display-5 text-white font-weight-bold mb-4">
                Whate is BMI?
              </h4>
              ...
              <form>
                ...
                <div className="form-row">
                  <div className="col">
                    <input
                      type="button"
                      className="btn btn-lg btn-block btn-dark border-light w-100"
                      value="Calculate Now"
                    />
                  </div>
                </div>
