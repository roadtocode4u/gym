...
export default function Nutrians() {
  return (
    <>
      <h1 className="text-center  p-2 exercise-title mt-2"> Nutrians...🥚🍳</h1>
      <div className="container">
        ...
        <div>
         ...
         <p className="paragraph-text"> Apart from this your body also gets the required omega 3 fatty acids for good hormones production and skin and hair health, and remember that fats are important for your body, they are needed for good hormones production that indirectly impacts your mood and muscles growth progress.</p>
          ...
          <div>
            <h2>Best Nutrians to Help Weight Increase...</h2>
            {/* <img src={ExciseImg5}
          ...
          <div>
           ...
           <img className="img-fluid nutrains-img" src={NutrainsImg4} alt="" /> 
            ...
            <ol>
              <li className="paragraph-text">It provides a good balance of proteins, carbs, and fats and is a good source of calcium, as well as other vitamins and minerals.</li>
           ...
           <img className="img-fluid nutrains-img" src={NutrainsImg5} alt="" /> 
            ...
            <ol>
              ...
              <ol c>
                <li className="paragraph-text">butter and Parmesan cheese</li>
                <li className="paragraph-text">broccoli and cheese</li>
                <li className="paragraph-text">scrambled eggs</li>
                <li className="paragraph-text">toasted sesame seeds, peanuts, or cashews</li>
              </ol>
